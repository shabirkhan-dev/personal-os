---
title: Architecture Overrides
description: How to document intentional deviations from Personal OS defaults.
---
Use this file to record intentional deviations from Personal OS defaults.

## Why this exists

Personal OS is intentionally opinionated, but not rigid. Overrides are valid when they
